"""Fetch and save HTML from GET /Organisations/{organisationId}/Tasks/OutputData.
...
OUTPUT = os.path.join(os.path.dirname(__file__), "organisation_output_data.html")

client = get_client()

dashboard = client.session.get(client.base_url + "User")
...
response = client.session.get(
    client.base_url + f"Organisations/{org_id}/Tasks/OutputData"
)
